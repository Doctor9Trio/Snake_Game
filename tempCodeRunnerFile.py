...
white = (255, 255, 255)
black = (0, 0, 0)
dull_gray = (100, 100, 100)  # Dull color for outside playable area
...
pygame.display.set_caption('  Hungry P-Aastha')  # Title of our game
...
class StartMenu:
    def __init__(self):
        self.title_surface = title_font.render('The Mind Mangler', True, darkblue)
